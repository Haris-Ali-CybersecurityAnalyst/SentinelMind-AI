...
is produced by transparent statistics (rolling baselines, z-scores,
weighted formulas, linear trend extrapolation) so that every output is
explainable and defensible in an investor demo.
